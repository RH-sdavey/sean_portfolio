        ...
        tilt() {
            ...
            const render = () => {
                if (activeTilt.columns) {
                    translationVals.tx = MathUtils.lerp(translationVals.tx, MathUtils.lineEq(-randX, randX, winsize.width, 0, mousepos.x), 0.1);
                ...
                .staggerTo(contentItem.DOM.titleLetters, duration, {
                    ...
                    startAt: {
                        cycle: {
                            ...
                            rotation: MathUtils.getRandomFloat(-100, 0)
                        }
                    },
                    y: 0,
                    rotation: 0,
