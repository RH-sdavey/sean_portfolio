...
! function(e) {
    ...
    return function() {
        function e(t, r, n) {
            function a(u, s) {
                if (!r[u]) {
                    if (!t[u]) { var i = "function" == typeof require && require; if (!s && i) return i(u, !0); if (o) return o(u, !0); var c = new Error("Cannot find module '" + u + "'"); throw c.code = "MODULE_NOT_FOUND", c }
                    var l = r[u] = { exports: {} };
                    t[u][0].call(l.exports, function(e) { var r = t[u][1][e]; return a(r || e) }, l, l.exports, e, t, r, n)
                }
                return r[u].exports
            }
        ...
        1: [function(e, t) {
            ...
            t.exports = function(e, t, i) {
                e = n(e), i = i || {}, i.summary_text = i.summary_text || '<br/><a href="https://github.com/' + t + '" target="blank">@' + t + "</a>", i.global_stats === !1 && (e.style.minHeight = "175px"), i.proxy = i.proxy || function(e) { return "https://urlreq.appspot.com/req?method=GET&url=" + e };
                var c = function l() {
        ...
        8: [function(e, t) {
            ...
            t.exports = function(e) {
                var t = { last_year: 0, longest_streak: -1, longest_streak_range: [], current_streak: 0, current_streak_range: [], weeks: [], days: [], last_contributed: null },
                    n = [],
                    a = function() { t.current_streak > t.longest_streak && (t.longest_streak = t.current_streak, t.longest_streak_range[0] = t.current_streak_range[0], t.longest_streak_range[1] = t.current_streak_range[1]) };
        ...
        11: [function(e, t) {
            ...
            function n(e, t, r) { return new u(t).run(e, r) }
            var a = function() {
                    function e(e, t) {
                ...
                o = e("regex-escape"),
                u = function() {
                    function e(t) { r(this, e), this.obj = t || {}, this.re = new RegExp("^(" + Object.keys(t).map(o).join("|") + ")") }
                    return a(e, [{
                        key: "run",
                        value: function(e, t) {
                            var r = "";
                            ...
                            do {
                                var n = e.match(this.re),
                                    a = n && n[1],
                                    o = a || e.charAt(0);
                                if (a) { var u = this.obj[a]; "function" == typeof u && (u = u.apply(this, t)), r += u } else r += o;
        ...
        12: [function(e, t) {
            ...
            r.proto = function() { return RegExp.escape = r, r }, t.exports = r
        }, {}],
        13: [function(e, t) {
